...
class Amoeba_Dashboard {
    ...
    public function add_admin_menu() {
        ...
        add_menu_page(
            __( 'Amoeba Modals', 'amoeba-modal-creator' ),
            __( 'Amoeba Modals', 'amoeba-modal-creator' ),
            'manage_options',
            'amoeba-modals',
        ...
        add_submenu_page(
            'amoeba-modals',
            __( 'All Modals', 'amoeba-modal-creator' ),
            __( 'All Modals', 'amoeba-modal-creator' ),
            'manage_options',
            'amoeba-modals',
            array( $this, 'render_dashboard_page' )
        ...
        add_submenu_page(
            'amoeba-modals',
            __( 'Add New Modal', 'amoeba-modal-creator' ),
            __( 'Add New', 'amoeba-modal-creator' ),
            'manage_options',
    ...
    public function render_dashboard_page() {
        ...
        if ( isset( $_GET['action'] ) && $_GET['action'] === 'delete' && isset( $_GET['id'] ) ) {
            ...
            echo '<div class="updated"><p>' . __( 'Modal deleted.', 'amoeba-modal-creator' ) . '</p></div>';
            // Refresh list
            $modals = $wpdb->get_results( "SELECT * FROM $table_name ORDER BY id DESC" );
        }
        ...
        ?>
        <div class="wrap">
            <h1 class="wp-heading-inline"><?php _e( 'Amoeba Modals', 'amoeba-modal-creator' ); ?></h1>
            <a href="<?php echo admin_url( 'admin.php?page=amoeba-settings' ); ?>" class="page-title-action"><?php _e( 'Add New', 'amoeba-modal-creator' ); ?></a>
            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5"><?php _e( 'No modals found. Create your first one!', 'amoeba-modal-creator' ); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
