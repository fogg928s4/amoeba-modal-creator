...
class Amoeba_Scripts
{
    ...
    public function enqueue_frontend_assets()
    {
        ...
        wp_enqueue_style('amoeba-frontend-css', plugins_url('assets/css/trigger.css', dirname( __FILE__ ) ), array(), '1.0.0');
        wp_enqueue_style('amoeba-frontend-css', plugins_url('assets/css/overlay.css', dirname( __FILE__ ) ), array(), '1.0.0');
        wp_enqueue_style('amoeba-frontend-css', plugins_url('assets/css/cv-specifics.css', dirname( __FILE__ ) ), array(), '1.0.0');
